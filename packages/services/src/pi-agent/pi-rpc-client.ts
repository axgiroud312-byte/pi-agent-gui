/* eslint-disable max-lines -- A single process lifetime and ordered JSONL writer share state; splitting the class would obscure its failure and backpressure invariants. */
