...
import { PiRpcClient, PiRpcError, RPC_LIMITS, type PiRpcClientOptions, type RpcDiagnostic, type RpcExit } from '../../src/runtime/pi-rpc-client.js';
...
const fixture = resolve(cwd, 'tests/fixtures/rpc-child.mjs');
